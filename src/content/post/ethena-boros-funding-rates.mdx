...
| Quarter | Market | Funding APR | Income |
| --- | --- | --- | --- |
| Q1 | Bull market | 32% | +\$80M |
| Q2 | Sideways | 11% | +\$27.5M |
| Q3 | Bear market | -22% | -\$55M |
| Q4 | Recovery | 16% | +\$40M |
...
| Scenario | Funding | Binance | Boros Fixed | Boros Floating | **Net** |
| --- | --- | --- | --- | --- | --- |
| A | 25% APR | +25% | +10% | -25% | **10%** |
| B | 10% APR | +10% | +10% | -10% | **10%** |
| C | 2% APR | +2% | +10% | -2% | **10%** |
...
<div class="my-8">
  <div class="flex flex-col md:flex-row items-stretch gap-0 font-mono text-sm">
    {/* Before */}
    <div class="flex-1 border border-[var(--border)] rounded-t-lg md:rounded-l-lg md:rounded-tr-none p-5 bg-[var(--bg-paper)]">
    ...
    {/* Arrow */}
    <div class="flex items-center justify-center bg-[var(--border)] w-full md:w-12 h-8 md:h-auto">
      <svg
        class="w-5 h-5 text-[var(--text-muted)] md:rotate-0"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
        stroke-width="2"
    ...
    {/* After */}
    <div class="flex-1 border border-[var(--border)] rounded-b-lg md:rounded-r-lg md:rounded-bl-none p-5 bg-[var(--bg-paper)]">
      <div class="text-xs text-[var(--text-muted)] uppercase tracking-wider mb-2">
        After Boros
      </div>
...
<div class="my-8 font-mono text-sm">
  <div class="flex flex-col sm:flex-row items-center justify-center gap-0">
    ...
    {/* Arrows */}
    <div class="flex flex-col sm:flex-row items-center py-2 sm:py-0 sm:px-0 relative">
      {/* Mobile: vertical layout */}
      <div class="flex sm:hidden flex-col items-center gap-1">
        {/* Fixed arrow going down (to speculator) */}
        <div class="flex items-center gap-2 bg-[var(--bg)] px-3 py-1">
          <span class="text-xs text-[var(--text-muted)] whitespace-nowrap">10% Fixed</span>
          <svg class="w-4 h-6 text-[var(--text-faint)]" fill="none" viewBox="0 0 16 24" stroke="currentColor" stroke-width="1.5">
            <path stroke-linecap="round" stroke-linejoin="round" d="M8 2v20m-4-4l4 4 4-4" />
          </svg>
        </div>
        <div class="h-4 w-px bg-[var(--border)]"></div>
        {/* Floating arrow going up (to ethena) */}
        <div class="flex items-center gap-2 bg-[var(--bg)] px-3 py-1">
          <svg class="w-4 h-6 text-[var(--text-faint)]" fill="none" viewBox="0 0 16 24" stroke="currentColor" stroke-width="1.5">
            <path stroke-linecap="round" stroke-linejoin="round" d="M8 22V2m-4 4l4-4 4 4" />
          </svg>
          <span class="text-xs text-[var(--text-muted)] whitespace-nowrap">Floating</span>
        </div>
      </div>
      ...
      <div class="hidden sm:flex flex-col items-center">
        ...
        <div class="flex items-center gap-2 bg-[var(--bg)] px-3 py-1 relative">
          <svg
            class="w-8 h-4 text-[var(--text-faint)] rotate-180"
            fill="none"
            viewBox="0 0 32 16"
            stroke="currentColor"
            stroke-width="1.5"
...
| Liquidation buffer | 2 days |
| Safety factor | 1.5x |
| **Required margin** | **\$7.5M** |
| **Capital efficiency** | **133x** (\$1B / \$7.5M) |
