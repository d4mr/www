...
Enter [nanoreth](https://github.com/hl-archive-node/nanoreth), a community tool that reads this S3 block data and exposes it as a standard Ethereum RPC. This lets block explorers work with HyperEVM as if it were a normal EVM chain.
